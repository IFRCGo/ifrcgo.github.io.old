function initTree(data){
	...
	data.forEach(function(node) {
		// add to parent
		var parent = dataMap[node['#meta+parent']];
		if (parent) {
	...
	function update(source) {
	  ...
	  nodeEnter.append("circle")
		  .attr("r", 1e-6)
		  .style("fill", function(d) { return d._children ? "#FFEBEE" : "#fff"; });

	  nodeEnter.append("text")
		  .attr("x", function(d) { return d.children || d._children ? 0 : 13; })
		  .attr("y", function(d) { return d.children || d._children ? 20 : 0; })
		  .attr("dy", ".35em")
...
var dataCall = $.ajax({
	type: "GET",
	url: "https://proxy.hxlstandard.org/data.json?url=https%3A//docs.google.com/spreadsheets/d/1Oq1oojmRjgDxt_OCQkrKk6BLG4hXFiDcKYCymmM-Iu0/edit%23gid%3D0",
	dataType: 'json',
